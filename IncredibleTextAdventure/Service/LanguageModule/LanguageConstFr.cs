...
{
    public class LanguageConstFr : ILanguageConst
    {
        public LanguageConstFr()
        {
            Hello = "Bonjour";
        }

        public string Hello { get; }
        public string OpenSpaceName { get; }
        public string DeskOneName { get; }
        public string DeskTwoName { get; }
        public string DeskThreeName { get; }
        public string DeskFourName { get; }
